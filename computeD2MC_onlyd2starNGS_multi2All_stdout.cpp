...
vector<double> d2starComputeNGS(int ZI, int k, KMERINFO* speciesKmerInfoA, KMERINFO* speciesKmerInfoB)
{
  // compute D2 statistics
//  SCIENTIFIC_NUMBER D2, D2star, D2shepp;
...
void computeMultiStats(int ZI, int k, KMERINFO* speciesKmerInfoA, KMERINFO* speciesKmerInfoB, SPECIESINFO speciesInfoA, SPECIESINFO speciesInfoB)
{
	...
	vector<double> d2starNGSvalues = d2starComputeNGS(ZI, k, speciesKmerInfoA, speciesKmerInfoB);
	//printFour(D2C2values);
	cout << "d2starNGS" << ", " << d2starNGSvalues[0] << endl;
