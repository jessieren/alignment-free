...
int main(int argc, char **argv)   //EDIT main(int argc, char *argv[])
{
	...
	/////////////////////// output matrix /////////////////////////////////
	///////////////////////////////////////////////////////////////////////
	vector<vector<vector<SCIENTIFIC_NUMBER> > > resultMatrix (11, vector<vector<SCIENTIFIC_NUMBER> > (speciesInfoListA.size(), vector<SCIENTIFIC_NUMBER> (speciesInfoListB.size())));
  ...
  // load the kmer count hashtables of the first file list (the fat list)
	...
	for(int IDB = 0; IDB < speciesInfoListB.size(); IDB++)
	{
		...
		for(int IDA = 0; IDA < speciesInfoListA.size(); IDA++)
		{
			...
			cout << ", " << speciesInfoB.name << " - " << speciesInfoA.name << endl;
