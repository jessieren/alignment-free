      ...
      ChDist = diff;
		...
		if( currentKmerRevTen >= currentKmerTen )
		{
			if(  currentKmerRevTen != currentKmerTen )
			{
				...
				cout << "kmerFreqX1: " << speciesKmerInfoA->HashTable[currentKmerTen] + speciesKmerInfoA->HashTable[currentKmerRevTen] << "; kmerFreqX2: " << speciesKmerInfoB->HashTable[currentKmerTen] + speciesKmerInfoB->HashTable[currentKmerRevTen] << endl;
				...
				cout << "kmerFreqX1: " << speciesKmerInfoA->HashTable[currentKmerTen]  << "; kmerFreqX2: " << speciesKmerInfoB->HashTable[currentKmerTen] << endl;
			...
			cout << "XU1: " << TransToReal(XU1) << ", XU2:" << TransToReal(XU2) << ", diffU: " << TransToReal(diffU) << endl;
